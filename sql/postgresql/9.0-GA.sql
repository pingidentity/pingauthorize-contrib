...
-- Lock Database
UPDATE public.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '127.0.0.1 (127.0.0.1)', LOCKGRANTED = '2021-12-13 11:08:53.096' WHERE ID = 1 AND LOCKED = FALSE;
