...
ALTER TABLE public."AttributeResolver" ADD attribute_definition_id VARCHAR(36);16:04:04.684 [main] DEBUG liquibase.changelog.visitor.UpdateVisitor - Running Changeset:META-INF/resourcesPrivate/com.symphonicsoft.db.cli/liquibase/8.0/add-policy2-table.xml::1::symphonic
