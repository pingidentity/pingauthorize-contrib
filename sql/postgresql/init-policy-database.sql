...
-- Lock Database
UPDATE public.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '127.0.0.1 (127.0.0.1)', LOCKGRANTED = '2022-06-27 15:31:20.381' WHERE ID = 1 AND LOCKED = FALSE;
