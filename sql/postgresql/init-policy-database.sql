...
-- Lock Database
UPDATE public.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '127.0.0.1 (127.0.0.1)', LOCKGRANTED = '2021-07-23 08:26:51.012' WHERE ID = 1 AND LOCKED = FALSE;
